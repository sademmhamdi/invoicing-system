...
|
*/
$config['base_url'] = 'http://localhost/invoice-landing/';
...
|
*/
$config['encryption_key'] = 'your_32_character_secret_key_here_123';
...
$config['csrf_exclude_uris'] = array('chatbot/ask', 'chatbot/token');
